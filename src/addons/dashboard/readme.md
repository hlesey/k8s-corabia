...
```bash
for i in kubernetesui/dashboard-auth:1.4.0 kubernetesui/dashboard-api:1.14.0 kubernetesui/dashboard-web:1.7.0 kubernetesui/dashboard-metrics-scraper:1.2.2; do
