...
* Windows:
  * [git bash v2.52.0](https://github.com/git-for-windows/git/releases/download/v2.52.0.windows.1/Git-2.52.0-64-bit.exe)
  * [VSCode](https://code.visualstudio.com/download)
* Linux:
  * [git](https://git-scm.com/book/en/v2/Getting-Started-Installing-Git)
  * [VSCode](https://code.visualstudio.com/download)
...
The following script needs to be executed from `labs` folder: `./k8s-corabia/src/tools/configure-kubectl.sh`
